...
namespace Aris
{
	...
	namespace Dynamic
	{
		...
		void dlmread(const char *filename, double *mtx);
		...
		*/
		...
		void s_block_cpy(const int &block_size_m, const int &block_size_n,
			...
			double *to_mtx, const int &tm_begin_row, const int &tm_begin_col, const int &tm_ld) noexcept;
		void s_block_cpy(const int &block_size_m, const int &block_size_n,
			double alpha, const double *from_mtx, const int &fm_begin_row, const int &fm_begin_col, const int &fm_ld,
			double beta, double *to_mtx, const int &tm_begin_row, const int &tm_begin_col, const int &tm_ld) noexcept;
