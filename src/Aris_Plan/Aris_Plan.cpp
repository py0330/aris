...
namespace Aris
{
	namespace Plan
	{
		...
		bool FAST_PATH::ComputeDdsBundPure(FAST_PATH::DATA &data, std::vector<FAST_PATH::MOTOR_LIMIT> &limits)
		{
			...
			Aris::DynKer::s_dgemm(locData.size, 1, locData.size, 1, locData.Ji, locData.size, locData.g, 1, 0, J_dot_g.data(), 1);
			Aris::DynKer::s_dgemm(locData.size, 1, locData.size, 1, locData.Ji, locData.size, locData.h, 1, 0, J_dot_h.data(), 1);
			Aris::DynKer::s_dgemm(locData.size, 1, locData.size, 1, locData.dJi, locData.size, locData.g, 1, 0, dJ_dot_g.data(), 1);
