...
namespace aris::robot
{
	...
	auto createRokaeXB4Interface()->std::string
	{
		return 
			...
			"        <Panel text=\"Simulator|模拟器\" id=\"id_20\">"
			"            <Button text=\"Enable|使能\" id=\"id_21\" cmd=\"mm --stop;am --stop;ds;md;en;rc\" return_attached=\"\"/>"
			"            <Button text=\"Disable|去使能\" id=\"id_22\" cmd=\"mm --stop; am --stop; ds;\" return_attached=\"\"/>"
			"            <Button text=\"Reset|重置\" id=\"id_23\" cmd=\"mm --stop; am --stop; rs; rc;\" return_attached=\"\"/>"
			"        </Panel>"
			"        <Panel text=\"Manual|手动\" id=\"id_21\">"
			"            <Button text=\"Start|启动\" id=\"id_18\" cmd=\"mm --stop; am --stop;mm --start\" return_attached=\"\"/>"
			"            <Button text=\"Stop|停止\" id=\"id_19\" cmd=\"mm --stop; am --stop;mm --stop\" return_attached=\"\"/>"
			"            <Panel text=\"Translate|平移\" id=\"id_8\">"
			"                <Button text=\"Heave+|上\" id=\"id_2\" repeat=\"0\" rate=\"50\" cmd=\"mm --z=1\" return_attached=\"\" width=\"80\"/>"
			"                <Button text=\"Heave-|下\" id=\"id_3\" repeat=\"0\" rate=\"50\"  cmd=\"mm --z=-1\" return_attached=\"\"/>"
			"                <Button text=\"Sway+|左\" id=\"id_4\" repeat=\"0\" rate=\"50\"  cmd=\"mm --x=1\" return_attached=\"\"/>"
			"                <Button text=\"Sway-|右\" id=\"id_5\" repeat=\"0\"  rate=\"50\" cmd=\"mm --x=-1\" return_attached=\"\"/>"
			"                <Button text=\"Surge+|前\" id=\"id_6\" repeat=\"0\"  rate=\"50\" cmd=\"mm --y=1\" return_attached=\"\"/>"
			"                <Button text=\"Surge-|后\" id=\"id_7\" repeat=\"0\"  rate=\"50\" cmd=\"mm --y=-1\" return_attached=\"\"/>"
			"            </Panel>"
			"            <Panel text=\"Rotate|转动\" id=\"id_9\">"
			"                <Button text=\"Yaw+|左偏\" id=\"id_10\" repeat=\"0\"  rate=\"50\" cmd=\"mm --c=1\" return_attached=\"\"/>"
			"                <Button text=\"Yaw-|右偏\" id=\"id_11\" repeat=\"0\"  rate=\"50\" cmd=\"mm --c=-1\" return_attached=\"\"/>"
			"                <Button text=\"Roll+|左倾\" id=\"id_12\" repeat=\"0\"  rate=\"50\" cmd=\"mm --a=1\" return_attached=\"\"/>"
			"                <Button text=\"Roll-|右倾\" id=\"id_13\" repeat=\"0\"  rate=\"50\" cmd=\"mm --a=-1\" return_attached=\"\"/>"
			"                <Button text=\"Pitch+|前倾\" id=\"id_14\" repeat=\"0\"  rate=\"50\" cmd=\"mm --b=1\" return_attached=\"\"/>"
			"                <Button text=\"Pitch-|后倾\" id=\"id_15\" repeat=\"0\"  rate=\"50\" cmd=\"mm --b=-1\" return_attached=\"\"/>"
			"            </Panel>"
			"        </Panel>"
			"        <Panel text=\"Auto|自动\" id=\"id_16\">"
			"            <Button text=\"Start|启动\" id=\"id_16\" cmd=\"mm --stop; am --stop;am --start\" return_attached=\"\"/>"
			"            <Button text=\"Stop|停止\" id=\"id_17\" cmd=\"mm --stop; am --stop;am --stop\" return_attached=\"\"/>"
			"        </Panel>"
