#ifndef ARIS_DYNAMIC_MECHANISM_RPPR_H_
#define ARIS_DYNAMIC_MECHANISM_RPPR_H_
...
namespace aris::dynamic{
	...
	auto ARIS_API createModelRppr(const RpprParam &param)->std::unique_ptr<aris::dynamic::Model>;
