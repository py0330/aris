...
void test_simple_model()
{
	...
	const double ll_j3_pos[]{ 0.7561938, -0.625294, -2.468108 };
	const double ll_j3_axis[]{ -0.1155414, 0.9933026, -1.490116E-07 };
	const double ll_j4_pos[]{ 0.6081899, -0.4607367, -2.862 };
	const double ll_j4_axis[]{ -1.275331E-06, 2.9751E-07, 1 };
	const double ll_j5_pos[]{ 0.6843457, -0.5585557, -3.547571 };
	const double ll_j5_axis[]{ -0.1155409, 0.9933028, -2.980232E-08 };
	...
	const double rl_j3_pos[]{0.7361314, 0.3400754, -2.468108};
	const double rl_j3_axis[]{0.02464789, 0.9996961, 0};
	const double rl_j4_pos[]{0.6126211, 0.5237312, -2.862};
	const double rl_j4_axis[]{-1.084796E-06, 4.846983E-07, 1};
	const double rl_j5_pos[]{0.6743334, 0.4162145, -3.547571};
	const double rl_j5_axis[]{0.02464855, 0.9996961, 0};
	...
	//for (auto &mot : m1.motionPool())mot.activate(false);
	//for (auto &gmt : m1.generalMotionPool()) 
	//{
	//	std::cout << "test" << std::endl;
	//	
	//	gmt.updMp();
	//	aris::dynamic::dsp(4, 4 ,*gmt.mpm());
	//}
