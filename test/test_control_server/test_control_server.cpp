...
"            <m1 type=\"EthercatMotion\" phy_id=\"0\" product_code=\"0x00030924\" vendor_id=\"0x0000009a\" revision_num=\"0x000103F6\" dc_assign_activate=\"0x0300\" min_pos=\"-10.0\" max_pos=\"10.0\" max_vel=\"10.0\" home_pos=\"0\" pos_factor=\"62914560\">"
...
"                </sdo_pool>"
"            </m1>"
"            <m2 type=\"EthercatMotion\" phy_id=\"1\" product_code=\"0x00030924\" vendor_id=\"0x0000009a\" revision_num=\"0x000103F6\" dc_assign_activate=\"0x0300\" min_pos=\"-10.0\" max_pos=\"10.0\" max_vel=\"10.0\" home_pos=\"0\" pos_factor=\"22937600\">"
"                <pdo_group_pool type=\"PdoGroupPoolObject\">"
"                    <index_1600 type=\"PdoGroup\" default_child_type=\"Pdo\" index=\"0x1600\" is_tx=\"false\">"
"                        <control_word index=\"0x6040\" subindex=\"0x00\" size=\"2\"/>"
"                        <mode_of_operation index=\"0x6060\" subindex=\"0x00\" size=\"1\"/>"
...
"                </sdo_pool>"
"            </m2>"
"            <m3 type=\"EthercatMotion\" phy_id=\"2\" product_code=\"0x00030924\" vendor_id=\"0x0000009a\" revision_num=\"0x000103F6\" dc_assign_activate=\"0x0300\" min_pos=\"-10.0\" max_pos=\"10.0\" max_vel=\"10.0\" home_pos=\"0\" pos_factor=\"22937600\">"
"                <pdo_group_pool type=\"PdoGroupPoolObject\">"
"                    <index_1600 type=\"PdoGroup\" default_child_type=\"Pdo\" index=\"0x1600\" is_tx=\"false\">"
"                        <control_word index=\"0x6040\" subindex=\"0x00\" size=\"2\"/>"
"                        <mode_of_operation index=\"0x6060\" subindex=\"0x00\" size=\"1\"/>"
...
auto rc_plan_func(const aris::dynamic::PlanParam &param)->int
{
	...
	param.model_->motionPool().at(0).setMp(begin_pos + p->mag * std::sin(2 * aris::PI * param.count_ / p->t1));
...
void test_construct()
{
	...
	auto &s1 = cs.controller().slavePool().add<aris::control::EthercatMotion>("s1", 0, 0x0000009a, 0x00030924, 0x000103F6, 0x0300, 65536, 10.0, -10.0, 10.0, 0, 0);
